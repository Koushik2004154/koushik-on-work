        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto h-full">
          ...
          <div className="text-center lg:text-right order-1 lg:order-2">
            <div className="animate-fade-in">
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-12 max-w-2xl mx-auto lg:mx-0 lg:ml-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-end items-center mb-16 animate-fade-in">
            ...
            {/* Social Links */}
            <div className="flex justify-center lg:justify-end space-x-6 animate-fade-in">
              <a 
                href="#" 
